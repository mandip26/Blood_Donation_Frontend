...
function VisualizationComponent() {
  ...
  const reportHistory: ReportHistory[] = [
    ...
    },
    {
      ...
      parameters: bloodParameters.map((param) => ({
        ...param,
        value: param.value * 0.95,
      })),
    },
    {
      id: "3",
  ...
  const handleVisualize = async () => {
    ...
    try {
      ...
      // Make the API call to the backend - using the correct endpoint from the backend
  ...
  // Function to determine status based on comparing with reference range
  ...
  return (
    <div className="container mx-auto py-6 px-4">
              ...
              {!selectedFile ? (
                <>
                  ...
                  <p className="text-gray-500 text-center mb-4">
                    Upload your file for visualization
                  </p>
      ...
      {uploadStep === "error" && (
        <div className="bg-white rounded-xl shadow-md p-12 border border-red-100 mb-8">
          <div className="flex flex-col items-center justify-center">
              ...
              <div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
                  ...
                  <p className="text-gray-700 mb-4">
                    Your blood test results show that most parameters are within
                    normal range. However, there are a few areas that require
                    attention:
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        (11.5 thousand/µL) - This could indicate an infection or
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">
                        ...
                        (140 thousand/µL) - Slightly below the normal range.
                        This could affect blood clotting.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <AlertTriangle
                      ...
                      <span className="text-gray-700">
                        ...
                        (75%) - This often indicates a bacterial infection.
                      </span>
                    </li>
                  </ul>
                  <div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <p className="text-yellow-700 text-sm mt-1">
                      ...
                      these results, particularly regarding your elevated white
                      blood cell count and neutrophils, which may indicate an
                      active infection.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="h-60 flex items-center justify-center">
                      <div className="relative w-40 h-40">
                        ...
                        <div
                          ...
                          style={{
                            clipPath: "polygon(0 0, 71% 0, 71% 100%, 0 100%)",
                          }}
                        ></div>
                        <div
                          ...
                          style={{
                            clipPath:
                              "polygon(71% 0, 78% 0, 78% 100%, 71% 100%)",
                          }}
                        ></div>
                        <div
                          ...
                          style={{
                            clipPath:
                              "polygon(78% 0, 100% 0, 100% 100%, 78% 100%)",
                          }}
                        ></div>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start text-gray-700">
                    ...
                    Get a repeat blood test in 4-6 weeks to monitor your white
                    blood cell count
                  </li>
                  <li className="flex items-start text-gray-700">
                    <div className="rounded-full bg-primary-magenta/20 p-1 mt-0.5 mr-3 flex-shrink-0">
                    ...
                    Consider additional tests to determine the cause of elevated
                    neutrophils
                  </li>
                </ul>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start text-gray-700">
                    ...
                    Include more iron-rich foods in your diet to support red
                  ...
                  <li className="flex items-start text-gray-700">
                    ...
                    Moderate exercise can help improve blood circulation and
                    overall health
                  </li>
                </ul>
              </div>
