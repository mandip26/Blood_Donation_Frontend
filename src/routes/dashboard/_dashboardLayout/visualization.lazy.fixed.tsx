...
function VisualizationComponent() {
  ...
  const handleReportDelete = async () => {
    const reportId = extractedData?._id;
                  ...
                  >
                    <div>
                      <h3 className="text-lg font-medium text-gray-800">
                        {report.extraction_result.patient.name} -{" "}
                        {report.extraction_result.patient.date}
                      </h3>
                      <p className="text-sm text-gray-500">
                        Referred by:{" "}
                        {report.extraction_result.patient.referred_by}
                      </p>
                    </div>
                    <Button
                      variant="outline"
